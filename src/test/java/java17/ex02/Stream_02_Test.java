...
public class Stream_02_Test {
	...
	//	List<Customer> result = orders.stream().map(o->o.getCustomer()).collect(Collectors.toSet()).stream().toList();
	...
	//	long result = orders.stream().map(o->o.getCustomer()).collect(Collectors.toSet()).stream().toList().stream().count();
		long result = orders.stream().map(Order::getCustomer).collect(Collectors.toSet()).stream().toList().stream().count();
